		...
		<div className="pos-rel">
			...
			<Fade bottom effect="backdrop-filter">
				<div className="mt-500px mb-1000px">
					<GlassContainer className="h-300px max-w-700px m-auto p-40px">
						<div className="">
							<Fade bottom>
								<h2 className="fs-40px " style={{ color: 'white', mixBlendMode: 'multiply' }}>
									Hello,{' '}
								</h2>
							</Fade>
							<Fade bottom>
								<h2 className="fs-50px ">
									My name is <span className="fs-90px">Kurt</span>,
								</h2>
							</Fade>
							<Fade bottom>
								<h2 className="fs-50px ">
									I make <span className="fs-90px">Places</span> on the{' '}
									<span className="fs-90px">Internet</span>
								</h2>
							</Fade>
						</div>
					</GlassContainer>
			...
			<div style={{ zIndex: 1, top: '100vh' }} className="pos-abs w-100per jc-c">
				...
				<div className="w-100per ">
					<FadeInContainer height="700px" width="900px" fade={'left'}>
						<div className="">
					...
					<FadeInContainer height="700px" width="900px" top="300px" fade={'right'}>
						<div className="">
						...
						<div class="wrapper jc-c m-auto mt-2rem">
							<div className="w-100per">
								<h3 className="ta-c fs-20px">Animated Skills </h3>
								<div class="skills">
									<div class="details">
										<span>React</span>
										{/* <span>85%</span> */}
					...
					<FadeInContainer height="700px" width="900px" top="500px" fade={'left'}>
						<div className="">
				...
				{/* <Fade bottom>
					<div className="mt-50px ">
						<GlassContainer className="h-900px max-w-1000px m-auto">
							<p>Hello</p>
						</GlassContainer>
					</div>
				</Fade>
